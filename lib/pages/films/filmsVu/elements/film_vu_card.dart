...
import 'package:culture_app1/pages/films/filmsVu/elements/film_vu_pop_up.dart';
import 'package:flutter/material.dart';

class FilmVuCard extends StatefulWidget {
  final FilmsVu fv;
  ...
  @override
  State<FilmVuCard> createState() => _FilmVuCardState();
}

class _FilmVuCardState extends State<FilmVuCard> {
  @override
        ...
        showDialog(
          ...
          builder: (context) {
            return FilmVuPopUp(
              ...
              addPersonneFonction: widget.addPersonneFonction,
              supprPersonneFonction: widget.supprPersonneFonction,
