...
class FormAjouterSerie extends StatefulWidget {
  ...
  @override
  State<FormAjouterSerie> createState() => _FormAjouterSerieState();
}

class _FormAjouterSerieState extends State<FormAjouterSerie> {
  final titreController = TextEditingController();
  final anneeController = TextEditingController();
  final createurController = TextEditingController();
  final nbSaisonsController = TextEditingController();
  final nbEpisodesMoyenController = TextEditingController();
  final dureeMoyenneController = TextEditingController();
    ...
    return StatefulBuilder(
      builder: (context, setState) {
        return AlertDialog(
          ...
          title: EnteteForm(couleur: serieOrange, txt: 'Ajouter série'),
          content: Form(
            key: keyForm,
